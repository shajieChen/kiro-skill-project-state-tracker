...
Kiro Agent Skill — 管理 Research / Decision / Plan / LandingPrompt / TestPrompt 工件的完整生命周期。

## 功能

- 通过中心化 status.yaml 追踪所有工件的状态、依赖和前置条件
- 核心能力：**INFERENCE** — 读取文档内容自动提取 artifact ID、依赖关系、handoff context
...
| 组件 | 说明 |
|------|------|
| SKILL.md | 核心 Prompt (~1200 words) — SCL 合约 + 需求分页指针表 |
| templates/ | 项目初始化模板（目录结构 + 空文件） |
